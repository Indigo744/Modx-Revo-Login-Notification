...
set_time_limit(0);
/* define version */
define('PKG_NAME','LoginNotification');
define('PKG_NAMESPACE','loginnotification');
define('PKG_VERSION','1.0.0');
define('PKG_RELEASE','pl');
define('PKG_DESCRIPTION',sprintf('Email notification on login - %s-%s', PKG_VERSION, PKG_RELEASE));
/* define sources */
